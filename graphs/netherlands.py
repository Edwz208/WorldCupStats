...
netherlands_df = normalized_df[normalized_df['Country Name'] == 'NETHERLANDS']
...
def plot_radar_chart(data, metricsfun, title):
    ...
    color_palette = ['#F36C21', '#0500FF', '#9CDADB', '#FF00DE', '#FF9900', '#FFFFFF']
    ...
    plt.title("Netherlands Tournament Performance", color='white', fontsize = 30, pad=45, fontproperties = prop)


    return fig

fig = plot_radar_chart(netherlands_df, metrics_list, title="Soccer Radar Chart")
plot_path = os.path.join("images", "netherlands_spider.png")
