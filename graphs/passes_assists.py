...
color2 = 'white'
ax2 = ax1.twinx()
ax2.set_ylabel('Average Passes', color=color2, fontproperties=prop, fontsize = '22', labelpad = 25)
...
plt.title("Tournament Average Passes vs Assists", fontproperties=prop, color='white', fontsize = '22')

plot_path = os.path.join("images", "passes_assists.png")
