...
plt.figure(figsize=(19,16), facecolor= 'black')
...
plt.yticks(fontproperties = prop, color = 'white')
plt.title("Tournament Average Defensive Pressures Applied", fontproperties = prop, fontsize = 22, color = 'white' )
plt.ylabel("Defensive Pressure", fontproperties = prop, fontsize = 22, color = 'white', labelpad=25)
plt.ylim(bottom = 120)
